...
import { NotAMember } from "../../domain/errors/not-a-member.error.js";
...
export class RemoveMember {
  ...
  async execute(
    ...
    Result<{ event: MemberRemoved }, OrgNotFound | NotAMember | CannotRemoveOwner>
  > {
    ...
    if (!membership) {
      return Result.fail(NotAMember.create(input.userId));
    }
