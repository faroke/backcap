...
import type { PostNotFound } from "../domain/errors/post-not-found.error.js";
...
export interface IBlogService {
  createPost(input: CreatePostInput): Promise<Result<CreatePostOutput, InvalidSlug>>;
  publishPost(
    input: PublishPostInput,
  ): Promise<Result<PublishPostOutput, PostNotFound | PostAlreadyPublished>>;
  getPost(input: GetPostInput): Promise<Result<GetPostOutput, PostNotFound>>;
  listPosts(input: ListPostsInput): Promise<Result<ListPostsOutput, never>>;
}
