...
import type { IFeatureFlagsService } from "../../../domains/feature-flags/contracts/index.js";
// Template: import { FlagNotFound } from "{{cap_rel}}/feature-flags/domain/errors/flag-not-found.error.js";
import { FlagNotFound } from "../../../domains/feature-flags/domain/errors/flag-not-found.error.js";
// Template: import { FlagAlreadyInState } from "{{cap_rel}}/feature-flags/domain/errors/flag-already-in-state.error.js";
import { FlagAlreadyInState } from "../../../domains/feature-flags/domain/errors/flag-already-in-state.error.js";
// Template: import { FlagAlreadyExists } from "{{cap_rel}}/feature-flags/domain/errors/flag-already-exists.error.js";
import { FlagAlreadyExists } from "../../../domains/feature-flags/domain/errors/flag-already-exists.error.js";
// Template: import { InvalidFlagKey } from "{{cap_rel}}/feature-flags/domain/errors/invalid-flag-key.error.js";
import { InvalidFlagKey } from "../../../domains/feature-flags/domain/errors/invalid-flag-key.error.js";
