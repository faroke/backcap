...
import type { IMediaService } from "../../../domains/media/contracts/index.js";
// Template: import { MediaNotFound } from "{{cap_rel}}/media/domain/errors/media-not-found.error.js";
import { MediaNotFound } from "../../../domains/media/domain/errors/media-not-found.error.js";
// Template: import { UnsupportedFormat } from "{{cap_rel}}/media/domain/errors/unsupported-format.error.js";
import { UnsupportedFormat } from "../../../domains/media/domain/errors/unsupported-format.error.js";
// Template: import { FileTooLarge } from "{{cap_rel}}/media/domain/errors/file-too-large.error.js";
import { FileTooLarge } from "../../../domains/media/domain/errors/file-too-large.error.js";
// Template: import { ProcessingFailed } from "{{cap_rel}}/media/domain/errors/processing-failed.error.js";
import { ProcessingFailed } from "../../../domains/media/domain/errors/processing-failed.error.js";
