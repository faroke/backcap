...
import type { IQueuesService } from "../../../domains/queues/contracts/index.js";
// Template: import { JobNotFound } from "{{cap_rel}}/queues/domain/errors/job-not-found.error.js";
import { JobNotFound } from "../../../domains/queues/domain/errors/job-not-found.error.js";
// Template: import { MaxAttemptsExceeded } from "{{cap_rel}}/queues/domain/errors/max-attempts-exceeded.error.js";
import { MaxAttemptsExceeded } from "../../../domains/queues/domain/errors/max-attempts-exceeded.error.js";
// Template: import { InvalidJobPayload } from "{{cap_rel}}/queues/domain/errors/invalid-job-payload.error.js";
import { InvalidJobPayload } from "../../../domains/queues/domain/errors/invalid-job-payload.error.js";
