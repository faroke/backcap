...
import type { IWebhooksService } from "../../../domains/webhooks/contracts/index.js";
// Template: import { WebhookNotFound } from "{{cap_rel}}/webhooks/domain/errors/webhook-not-found.error.js";
import { WebhookNotFound } from "../../../domains/webhooks/domain/errors/webhook-not-found.error.js";
// Template: import { WebhookDeliveryFailed } from "{{cap_rel}}/webhooks/domain/errors/webhook-delivery-failed.error.js";
import { WebhookDeliveryFailed } from "../../../domains/webhooks/domain/errors/webhook-delivery-failed.error.js";
// Template: import { InvalidWebhookUrl } from "{{cap_rel}}/webhooks/domain/errors/invalid-webhook-url.error.js";
import { InvalidWebhookUrl } from "../../../domains/webhooks/domain/errors/invalid-webhook-url.error.js";
